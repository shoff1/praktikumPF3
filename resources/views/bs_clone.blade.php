...
">
<link rel="stylesheet" href="{{ Vite::asset('resources/views/assets/css/style.css') }}">
</head>
...
<body>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{ Vite::asset('resources/views/assets/images/main.svg') }}" alt="main logo" />
                </div>
    ...
    text-white"></i>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/views/assets/images/bs-icons.png') }}" alt="Bootstrap Icons" />
                </div>
            </div>
        </div>
    </div>
    ...
    text-white"></i>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/views/assets/images/bs-themes.png') }}" alt="Bootstrap Themes" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="{{ Vite::asset('resources/views/assets/images/logo-black.svg') }}" alt="Bootstrap Logo"
                                style="width: 40px" />
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="{{ Vite::asset('resources/views/assets/images/logo-white.svg') }}" alt="logo" style="width: 40px" />
            </a>
            <!-- Navbar Toggler -->
            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap">
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active">Docs</a>
                        </li>
    ...
    bg-purple"
                                            type="button"><small>Latest (5.3.x) <i
                                    ...
                                    <li><button class="dropdown-item" type="button"><small>v5.0.2</small></button>
                                    </li>
                                    <li>
